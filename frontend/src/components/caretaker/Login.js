...
const CaretakerLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await authAPI.caretakerLogin({
    ...
    <div className="auth-container">
      <div className="auth-card">
        <div className="auth-header">
          <h1>Welcome Back</h1>
          <p>Sign in to your AlzCarePlus Caretaker account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-options">
            ...
            <a href="/caretaker/reset-password" className="forgot-password">
              Forgot Password?
            </a>
          </div>
        ...
        <div className="auth-footer">
          <p>
            ...
            <a href="/caretaker/register" className="auth-link">
              Sign up here
            </a>
          </p>
        </div>
